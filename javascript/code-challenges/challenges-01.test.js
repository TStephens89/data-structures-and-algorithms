...
const greeting = (word) => {
  // Solution code here...
  let hello = word.toUpperCase() + "!"
  // word.forEach(function(element){
  //   hello (element.toUpperCase() + "!")
  return hello;
  };
